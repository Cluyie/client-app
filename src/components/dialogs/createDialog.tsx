...
const CreateDialog = () => {
    ...
    const {createDialogVisible, createEditMachine ,toggleCreateDialogVisible, setImageText, setId, createMachine} = machineStore;
    ...
    const onSave = async () => {
        ...
        if(createEditMachine.id == "") {
            ...
            if(createEditMachine.id.length > 0) {
                console.log("Image about to be uploaded " + createEditMachine);
    ...
    return (
        <Dialog header="Header" visible={createDialogVisible} style={{ width: '25vw' }} footer={renderFooter()} onHide={() => toggleCreateDialogVisible()}>
            <div className="d-flex flex-column justify-content-center">
                <Image src={imageString as string} alt="Image" width="250" height="250" preview />
